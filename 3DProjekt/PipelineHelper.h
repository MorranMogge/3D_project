...
bool SetupPipeline(ID3D11Device* device, ID3D11VertexShader*& vShader, ID3D11PixelShader*& pShader, ID3D11PixelShader*& geometryPass, ID3D11InputLayout*& inputLayout, ID3D11SamplerState*& samplerState);